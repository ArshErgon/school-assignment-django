...
def student_register(request):
	...
	if student_form.is_valid():
		...
		StudentRegistration.objects.create(username=username, first_name=first_name, last_name=last_name, student_class=student_class, student_id=student_id, student_email=student_email, student_password=student_password)
		return redirect("/")
